...
curl -u elastic:changeme -s "http://$ADDRESS" 2>&1 > /dev/null
if [ $? != 0 ]; then
...
curl -u elastic:changeme -s -XDELETE "$ADDRESS/get-together" > /dev/null

# Create the next index using mapping.json
echo "Creating 'get-together' index..."
curl -u elastic:changeme -s -XPUT "$ADDRESS/get-together" -d@$(dirname $0)/mapping.json

# Wait for index to become yellow
curl -u elastic:changeme -s "$ADDRESS/get-together/_health?wait_for_status=yellow&timeout=10s" > /dev/null
echo
...
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/group/1" -d'{
  "name": "Denver Clojure",
...
echo
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/group/2" -d'{
...
echo
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/group/3" -d'{
...
echo
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/group/4" -d'{
...
echo
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/group/5" -d'{
...
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/event/100?parent=1" -d'{
  "host": ["Lee", "Troy"],
...
echo
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/event/101?parent=1" -d'{
  "host": "Sean",
...
echo
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/event/102?parent=1" -d'{
  "host": "Daniel",
...
echo
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/event/103?parent=2" -d'{
  "host": "Lee",
...
echo
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/event/104?parent=2" -d'{
  "host": "Lee",
...
echo
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/event/105?parent=2" -d'{
  "host": "Lee",
...
echo
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/event/106?parent=3" -d'{
  "host": "Mik",
...
echo
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/event/107?parent=3" -d'{
  "host": "Mik",
...
echo
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/event/108?parent=3" -d'{
  "host": "Elyse",
...
echo
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/event/109?parent=4" -d'{
  "host": "Andy",
...
echo
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/event/110?parent=4" -d'{
  "host": "Andy",
...
echo
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/event/111?parent=4" -d'{
  "host": "Andy",
...
echo
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/event/112?parent=5" -d'{
  "host": "Dave Nolan",
...
echo
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/event/113?parent=5" -d'{
  "host": "Dave",
...
echo
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/event/114?parent=5" -d'{
  "host": "Yann",
...
curl -u elastic:changeme -s -XPOST "$ADDRESS/get-together/_refresh"
...
curl -u elastic:changeme -s -XPUT "http://$ADDRESS/_template/logging_index_all" -d'{
...
echo
curl -u elastic:changeme -s -XPUT "http://$ADDRESS/_template/logging_index" -d '{
    "template" : "logstash-*",
    "order" : 0,
    "settings" : {
        "number_of_shards" : 2,
...
curl -u elastic:changeme -s -XDELETE "http://$ADDRESS/myindex" > /dev/null
curl -u elastic:changeme -s -XPUT "http://$ADDRESS/myindex" -d'
{
    "mappings" : {
        "my_type" : {
            "dynamic_templates" : [{
...
echo
echo "Adding Aliases"
curl -u elastic:changeme -s -XDELETE "http://$ADDRESS/november_2014_invoices" > /dev/null
curl -u elastic:changeme -s -XDELETE "http://$ADDRESS/december_2014_invoices" > /dev/null
curl -u elastic:changeme -s -XPUT "http://$ADDRESS/november_2014_invoices" -d'{}'
echo
curl -u elastic:changeme -s -XPUT "http://$ADDRESS/december_2014_invoices" -d'
{
    "mappings" :
    {
        "invoice" :
...
curl -u elastic:changeme -s -XPOST "http://$ADDRESS/_aliases" -d'
{
    "actions" : [
	{
		"add" :
